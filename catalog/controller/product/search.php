...
class ControllerProductSearch extends Controller {
    ...
    public function index() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/search.php')) {
            $this->template = $this->config->get('config_template') . '/template/product/search.php';
        } else {
