...
class ControllerModuleBossHomecategory extends Controller {
    ...
    protected function index($setting) {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/boss_homecategory.php')) {
            $this->template = $this->config->get('config_template') . '/template/module/boss_homecategory.php';
        } else {
