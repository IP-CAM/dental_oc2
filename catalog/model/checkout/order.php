            ...
            if (!empty($list['data'])) {
                if (!empty($data['payment_profession_type'])) {
                    ...
                    if (!empty($data['payment_profession_atuacao'])) {
                        $add_group['children'] = explode(',', $data['payment_profession_atuacao']);
                    } else {
                        $add_group['children'] = array($data['payment_profession_type']);
                    }

                    $groups = $mailchimp->addGroup($list['data']['id'], $add_group);
                    print_r($groups['data']['groups']);
                    die;
