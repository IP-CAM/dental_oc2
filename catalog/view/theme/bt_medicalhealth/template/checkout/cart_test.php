    ...
    <?php if ($coupon_status || $voucher_status || $reward_status || $shipping_status) { ?>
        ...
        <div class="cart-module">
            ...
            <div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                    <div><?php echo $entry_voucher; ?></div>

                    <div><input type="text" name="voucher" value="<?php echo $voucher; ?>" /></div>
                    <div><input type="hidden" name="next" value="voucher" /></div>

                    <div><span class="orange_button"><input type="submit" value="<?php echo $button_voucher; ?>" class="button" /></span></div>
                </form>
            </div>
