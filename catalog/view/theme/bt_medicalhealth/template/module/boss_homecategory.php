        ...
        <div id="boss_category_content<?php echo $module; ?>" class="boss_home_category">
            ...
            <?php foreach ($tabs as $key => $tab) { ?>
                <div class="boss_category_box<?php echo (($key + 1) % 5 == 0 ? ' last' : ''); ?> ">
                    ...
                    <?php } ?>
                    <div class="box box_home_category_php" id="categorytab-<?php echo $numTab; ?><?php echo $module; ?>">
                                        ...
                                        ?>
                                            ...
                                            <li <?php echo($i % $count == 0 ? 'class="last"' : ''); ?>>
                                                ...
                                                <div class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
                                                    <?php if (!empty($product['price']) && (!isset($product['product_on_phone']) || $product['product_on_phone'] != 1)) { ?>
                                                    <div class="price price_test product_id_<?php echo $product['product_id']; ?>">
