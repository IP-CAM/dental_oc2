...
class ControllerCatalogProduct extends Controller {
    ...
    protected function getForm() {
        ...
        //product options
        $conf_options = $this->model_catalog_product->getConfigurations();
        ...
        if (isset($this->request->get['product_config_id'])) {
            ...
            $product_config = $this->model_catalog_product->getProductConfigOption($this->data['product_config_id']);
        }
