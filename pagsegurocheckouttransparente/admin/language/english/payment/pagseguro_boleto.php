...
$_['text_success']        			= 'Módulo PagSeguro Checkout Transparente - Boleto atualizado com sucesso!';
$_['text_pagseguro_boleto'] 				= '<a onclick="window.open(\'http://www.pagseguro.com.br/\');"><img src="view/image/payment/pagseguro_uol.gif" alt="PagSeguro" title="PagSeguro" style="border: 1px solid #EEEEEE;" /></a>';
...
// Entry
$_['entry_nome_boleto'] = 'Texto a ser exibido na loja:<br /><span class="help">Ex: Boleto Bancário</span>';
...
$_['error_nome_boleto']         		= 'Digite um texto para exibição na loja';
?>