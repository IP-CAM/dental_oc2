<?php
// Heading
$_['heading_title']       			= 'PagSeguro Checkout Transparente - Débito Online';

// Text
$_['text_payment']        			= 'Pagamento';
$_['text_success']        			= 'Módulo PagSeguro Checkout Transparente - Débito Online atualizado com sucesso!';
$_['text_pagseguro_eft'] 				= '<a onclick="window.open(\'http://www.pagseguro.com.br/\');"><img src="view/image/payment/pagseguro_uol.gif" alt="PagSeguro" title="PagSeguro" style="border: 1px solid #EEEEEE;" /></a>';
...
// Entry
$_['entry_nome_eft'] = 'Texto a ser exibido na loja:<br /><span class="help">Ex: Débito em conta corrente</span>';
...
$_['entry_order_chargeback_debitado'] 			= 'Status Chargeback Debitado:<br /><span class="help">o valor da transação foi devolvido para o comprador.</span>';
$_['entry_order_contestacao'] 			= 'Status Contestação:<br /><span class="help">o comprador abriu uma solicitação de chargeback junto à operadora do cartão de crédito.</span>';
...
$_['error_nome_eft']         	= 'Digite um texto para exibição na loja';
?>