...
$_['text_pagseguro_credit_card'] 				= '<a onclick="window.open(\'http://www.pagseguro.com.br/\');"><img src="view/image/payment/pagseguro_uol.gif" alt="PagSeguro" title="PagSeguro" style="border: 1px solid #EEEEEE;" /></a>';
...
// Entry
$_['entry_nome_credit_card'] = 'Texto a ser exibido na loja:<br /><span class="help">Ex: Débito em conta corrente</span>';
...
$_['error_nome_credit_card']         	= 'Digite um texto para exibição na loja';
?>