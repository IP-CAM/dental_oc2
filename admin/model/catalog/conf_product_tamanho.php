...
class ModelCatalogConfProductTamanho extends Model {
    ...
    public function addTamanho($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "conf_product_tamanho SET ".implode($columns,","));
    ...
    public function editTamanho($conf_arcade_id, $data) {
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "conf_product_tamanho SET ".implode($columns,",")." WHERE id = '" . (int) $conf_arcade_id . "'");
    }
