...
class ModelCatalogConfProductCor extends Model {
    ...
    public function addCor($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "conf_product_cor SET ".implode($columns,","));
    ...
    public function editCor($conf_arcade_id, $data) {
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "conf_product_cor SET ".implode($columns,",")." WHERE id = '" . (int) $conf_arcade_id . "'");
    }
